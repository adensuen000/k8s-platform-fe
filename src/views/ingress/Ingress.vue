                ...
                <el-card class="ingress-head-card" shadow="never" :body-style="{padding:'10px'}">
                    <el-row>
                        ...
                        <el-col :span="16" style="text-align:right;">
                            <el-button size="small" icon="Refresh" plain @click="getIngresses()">刷新</el-button>
                        </el-col>
                    </el-row>
                </el-card>
            </el-col>
            ...
            <el-col :span="24">
                <el-card class="ingress-head-card" shadow="never" :body-style="{padding:'10px'}">
                    ...
                    <div style="float: left;margin-right:10px;">
                        <el-button @click="createIngressDrawer = true" size="small" type="primary" icon="Edit">创建</el-button>
                    </div>
                    <div>
                        <el-input class="ingress-head-search" size="small" clearable placeholder="请输入" v-model='searchValue'></el-input>
                        <el-button size="small" type="primary" plain icon="Edit" @click="getIngresses()">搜索</el-button>
                    </div>
                </el-card>
            </el-col>
            <el-col :span="24">
...
export default {
    ...
    methods: {
        ...
        getIngresses() {
            ...
            this.getIngressesData.params.filter_name = this.searchValue
            this.getIngressesData.params.namespace = this.namespaceValue
            this.getIngressesData.params.page = this.currentPage
            this.getIngressesData.params.limit = this.pagesize
            httpClient.get(this.getIngressesData.url, {params: this.getIngressesData.params})
            .then(res => {
