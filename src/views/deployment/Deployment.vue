<template>
    <div>
                    ...
                    <!-- v-loading用于加载时的laoding动画 -->
                        ...
                        <el-table-column label="操作" fixed="right" width="350">
                            <template v-slot="scope">
                                ...
                                <el-button size="small" icon="Edit" type="primary" @click="handleConfirm(scope, '重启', restartDeployment)">重启</el-button>
                                <el-button size="small" icon="Edit" type="danger" plain @click="handleConfirm(scope, '删除', delDeployment)">删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                    <!-- 分页配置 -->
        ...
        <!-- 扩缩 -->
        <el-dialog
            title="调整副本数" v-model="scaleDialog" width="25%">
