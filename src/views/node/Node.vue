        ...
        <el-row>
            ...
            <el-col :span="24">
                <el-card class="node-head-card" shadow="never" :body-style="{padding:'10px'}">
                    ...
                    <div>
                        <el-input class="node-head-search" size="small" clearable placeholder="请输入" v-model='searchValue'></el-input>
                        <el-button size="small" type="primary" plain icon="Edit" @click="getNodes()">搜索</el-button>
                    </div>
                </el-card>
            </el-col>
            <el-col :span="24">
...
export default {
    ...
    methods: {
        ...
        getNodes() {
            ...
            this.getNodesData.params.filter_name = this.searchValue
