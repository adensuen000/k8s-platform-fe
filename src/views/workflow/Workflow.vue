                ...
                <el-card class="workflow-head-card" shadow="never" :body-style="{padding:'10px'}">
                    <el-row>
                        ...
                        <el-col :span="16" style="text-align:right;">
                            <el-button size="small" icon="Refresh" plain @click="getWorkflows()">刷新</el-button>
                        </el-col>
                    </el-row>
                </el-card>
            </el-col>
            ...
            <el-col :span="24">
                <el-card class="workflow-head-card" shadow="never" :body-style="{padding:'10px'}">
                    ...
                    <div style="float: left;margin-right:10px;">
                        <el-button @click="createWorkflowDrawerIndex1 = true" size="small" type="primary" icon="Edit">创建工作流</el-button>
                    </div>
                    <div>
                        <el-input class="workflow-head-search" size="small" clearable placeholder="请输入" v-model='searchValue'></el-input>
                        <el-button size="small" type="primary" plain icon="Edit" @click="getWorkflows()">搜索</el-button>
                    </div>
                </el-card>
            </el-col>
            <!-- 数据表格 -->
...
export default {
    ...
    methods: {
        ...
        getWorkflows() {
            ...
            this.getWorkflowsData.params.name = this.searchValue
