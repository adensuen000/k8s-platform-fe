        ...
        <el-row>
                ...
                <el-card class="daemonset-head-card" shadow="never" :body-style="{padding:'10px'}">
                    <el-row>
                        ...
                        <el-col :span="16" style="text-align:right;">
                            <el-button size="small" icon="Refresh" plain @click="getDaemonSets()">刷新</el-button>
                        </el-col>
                    </el-row>
                </el-card>
            </el-col>
            ...
            <el-col :span="24">
                <el-card class="daemonset-head-card" shadow="never" :body-style="{padding:'10px'}">
                    ...
                    <div>
                        <el-input class="daemonset-head-search" size="small" clearable placeholder="请输入" v-model='searchValue'></el-input>
                        <el-button size="small" type="primary" plain icon="Edit" @click="getDaemonSets()">搜索</el-button>
                    </div>
                </el-card>
            </el-col>
            <el-col :span="24">
...
export default {
    ...
    methods: {
        ...
        getDaemonSets() {
            ...
            this.getDaemonSetsData.params.filter_name = this.searchValue
